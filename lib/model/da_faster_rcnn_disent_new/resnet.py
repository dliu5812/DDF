...
class resnet(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    # self.ds_enc_s = DSEncoder(dim = self.dout_base_model)

    self.ds_enc_s = nn.Sequential(resnet2.layer2, resnet2.layer3)
    ...
    self.ds_enc_s.apply(set_bn_fix)
  ...
  def train(self, mode=True):
    ...
    if mode:
      ...
      self.ds_enc_s.apply(set_bn_eval)
